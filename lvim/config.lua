...
lvim.keys.normal_mode["<leader>;"] = "A;<esc>"
lvim.keys.normal_mode["<leader>,"] = "A,<esc>"
...
-- For whatever reason LunarVim decided to swap the default increment/decrement keymaps
-- I'll swap them back.
-- lvim.keys.normal_mode["<C-a>"] = "<C-x>"
-- lvim.keys.normal_mode["<C-x>"] = "<C-a>"
...
--   endfunction
-- ]]
-- lvim.keys.normal_mode["gx"] = ":call BetterGX()<cr>"
